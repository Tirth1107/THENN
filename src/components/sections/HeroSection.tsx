  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "radial-gradient(circle, hsl(var(--primary) / 0.15) 0%, transparent 60%)",
      ...
      <motion.div
        ...
        style={{
          backgroundImage: "radial-gradient(circle, hsl(var(--primary) / 0.1) 0%, transparent 60%)",
          willChange: "transform",
        }}
        animate={{
          x: [0, -30, 0],
