...
const founders = [
    ...
    },
    {
        name: "Parth Joshi",
        role: "CFO",
        bio: "Managing client-side operations and ensuring financial stability and smooth project delivery at Thenn.",
        slug: "parth-joshi"
    },
];
...
const Founders = () => {
    return (
        <Layout>
            <SEO
                title="Founders — Tirth Joshi, Parth Joshi"
                description="Meet the leadership team at Thenn. Tirth Joshi (Founder & CEO) and Parth Joshi (CFO) carving the future of digital experiences."
                canonical="/founders"
            />
