...
const founders = [
    ...
    },
    {
        ...
        role: "CTO",
        bio: "Technical architect driving our high-performance development standards and complex web application builds.",
    },
];
    ...
    return (
        <Layout>
            ...
            <section className="pb-32 lg:pb-40">
                <div className="container mx-auto px-6 lg:px-12">
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 text-center" staggerDelay={0.1}>
                        {founders.map((founder, index) => (
                            <StaggerItem key={index}>
                                <div className="group p-8 border border-border/30 rounded-2xl bg-card/30 backdrop-blur-sm transition-all duration-500 hover:border-primary/30">
